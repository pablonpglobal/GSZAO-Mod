...
Begin VB.Form frmCustomKeys 
   ...
   Begin VB.TextBox Text1 
      ...
      Width           =   1620
   End
   Begin GSZAOCliente.uAOButton cDefaultKey 
      Height          =   570
      Left            =   960
      TabIndex        =   27
      Top             =   6600
      ...
      _ExtentX        =   4895
      _ExtentY        =   1005
      TX              =   "Cargar teclas por defecto"
      ENAB            =   -1  'True
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmCustomKeys.frx":3D6A5
      PICF            =   "frmCustomKeys.frx":3D6C1
      PICH            =   "frmCustomKeys.frx":3D6DD
      PICV            =   "frmCustomKeys.frx":3D6F9
      ...
      EndProperty
   End
   Begin GSZAOCliente.uAOButton cGuardarKey 
      Height          =   570
      Left            =   3840
      TabIndex        =   28
      Top             =   6600
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmCustomKeys.frx":3D715
      PICF            =   "frmCustomKeys.frx":3D731
      PICH            =   "frmCustomKeys.frx":3D74D
      PICV            =   "frmCustomKeys.frx":3D769
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   11.25
         Charset         =   0
   ...
   Begin GSZAOCliente.uAOButton cSalir 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmCustomKeys.frx":3D785
      PICF            =   "frmCustomKeys.frx":3D7A1
      PICH            =   "frmCustomKeys.frx":3D7BD
      PICV            =   "frmCustomKeys.frx":3D7D9
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   11.25
         Charset         =   0
