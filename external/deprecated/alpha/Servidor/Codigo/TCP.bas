...
Call WriteUserIndexInServer(UserIndex): DoEvents
...
Call MakeUserChar(True, UserList(UserIndex).Pos.map, UserIndex, UserList(UserIndex).Pos.map, _
                  UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y): DoEvents

Call WriteUserCharIndexInServer(UserIndex): DoEvents
''[/el oso]
