...
Dim ind As Integer
ind = Val(ReadField(2, List1.List(List1.ListIndex), 45)) ' GSZ 45 = Asc("-")
End Sub
...
Private Sub mnuBorrar_Click()
    ...
    'Pablo (ToxicWaste)
    Dim aux As String
    aux = mid$(ReadField(1, List1.List(List1.ListIndex), 45), 10, Len(ReadField(1, List1.List(List1.ListIndex), 45))) ' GSZ 45 = Asc("-")
