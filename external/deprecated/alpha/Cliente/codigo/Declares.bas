...
Public Engine As New clsEngineMain
...
' Constantes de intervalo || Parra: Se podria hacer más configurable..!!
...
' Parra: Esto hay que mejorarlo (habia un parche para esto si mal no recuerdo..)
' !!PARRA: HAY QUE ROKEAR ESTO (modulo user)
...
' Parra: Esto lo volamos, y hacemos algo para leer desde archivo.. no tan empalagoso
...
' Parra: uff... todo esto es una mierda desordenada..
...
'Parra: ESTADO LOGIN???? esto va fuera, y hay que hacer unas buenas cuentas con protocolo 10
