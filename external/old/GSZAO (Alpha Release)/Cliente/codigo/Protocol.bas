...
'***************************************************
    ...
    'Stop audio
    Call Engine.Sound_Stop
    Engine.IsPlaying = PlayLoop.plNone
    ...
    UserNavegando = False
    Engine.bRain = False
    Engine.bFogata = False
    SkillPoints = 0
    
    'Delete all kind of dialogs
    Call CleanDialogs
    
    Engine.Character_DestroyAll
...
'***************************************************
    ...
    For i = 1 To MAX_INVENTORY_SLOTS
        ...
        Else
            frmComerciar.List1(1).AddItem vbNullString ' GSZ
        End If
    Next i
...
'***************************************************
    ...
    For i = 1 To MAX_INVENTORY_SLOTS
        ...
        Else
            frmBancoObj.List1(1).AddItem vbNullString ' GSZ
        End If
    Next i
    ...
    For i = 1 To MAX_BANCOINVENTORY_SLOTS
        ...
        Else
            frmBancoObj.List1(0).AddItem vbNullString ' GSZ
        End If
    Next i
...
'***************************************************
    ...
    For i = 1 To MAX_INVENTORY_SLOTS
        ...
        Else
            frmComerciarUsu.List1.AddItem vbNullString ' GSZ
...
'***************************************************
    ...
    Dim tmpMap As Integer: tmpMap = incomingData.ReadInteger()

    Call incomingData.ReadInteger
    
    If Engine.Map_Change(tmpMap, incomingData.ReadASCIIString()) = False Then
...
'***************************************************
    ...
    Engine.Map_RemoveOldUser
    
    Engine.User_UpdatePos incomingData.ReadByte(), incomingData.ReadByte()
    
    'Set char
    Engine.User_CheckPosition
End Sub
...
'***************************************************
    ...
    Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & Engine.Character_GetName(incomingData.ReadInteger()) & MENSAJE_ATAQUE_FALLO, 255, 0, 0, True, False, False)
End Sub
...
'***************************************************
    ...
    attacker = Engine.Character_GetName(incomingData.ReadInteger())
...
'***************************************************
    ...
    victim = Engine.Character_GetName(incomingData.ReadInteger())
...
On Error GoTo ErrHandler
    ...
    If Engine.Character_IsActive(CharIndex) Then _
...
'***************************************************
    ...
    'Parra: Este paquete no se usa para nada.
...
'***************************************************
    ...
    Engine.UserCharIndex = incomingData.ReadInteger()
    Engine.User_CheckPosition
...
On Error GoTo ErrHandler
    ...
    Engine.Character_Create CharIndex, Body, Head, Heading, x, y, Weapon, Shield, Helmet, Buffer.ReadASCIIString(), Buffer.ReadByte(), Buffer.ReadByte()
    
    Engine.Character_SetFx CharIndex, Fx, Loops
    
    Engine.Character_RefreshAll
...
'***************************************************
    ...
    Engine.Character_Destroy CharIndex
    Engine.Character_RefreshAll
End Sub
...
'***************************************************
    ...
    Engine.Character_MoveByPos CharIndex, x, y
...
Private Sub HandleForceCharMove()
    ...
    Engine.User_MoveByHead Direccion
    Engine.User_MoveScreen Direccion
...
'***************************************************
    ...
    Engine.Character_Change incomingData.ReadInteger(), incomingData.ReadInteger(), incomingData.ReadInteger(), incomingData.ReadByte(), _
                            incomingData.ReadInteger(), incomingData.ReadInteger(), incomingData.ReadInteger(), _
...
'***************************************************
    ...
    Engine.Map_CreateObject GrhIndex, x, y
...
'***************************************************
    ...
    Dim Block As Boolean: Block = incomingData.ReadBoolean()
    
    If Block Then
        Engine.Map_SetBlocked x, y, 1
    Else
        Engine.Map_SetBlocked x, y, 0
    End If
End Sub
...
'***************************************************
    ...
    If currentMidi Then
        Call Engine.Music_Play(CStr(currentMidi) & ".mid", incomingData.ReadInteger())
    Else
...
'***************************************************
    ...
    Call Engine.Sound_Play(CStr(wave) & ".wav", srcX, srcY)
End Sub
...
'***************************************************
    ...
    Engine.Character_ChangeVisibility incomingData.ReadInteger(), incomingData.ReadBoolean()
...
'***************************************************
    ...
    If frmComerciar.Visible Then
        ...
        For i = 1 To MAX_INVENTORY_SLOTS
            ...
            Else
                Call frmComerciar.List1(1).AddItem(vbNullString) ' GSZ
            End If
        Next i
...
'***************************************************
    ...
    If frmBancoObj.Visible Then
        ...
        For i = 1 To MAX_INVENTORY_SLOTS
            ...
            Else
                Call frmBancoObj.List1(1).AddItem(vbNullString) ' GSZ
            End If
        Next i
...
On Error GoTo ErrHandler
    ...
    Engine.Character_ChangeTagAndStatus Buffer.ReadInteger(), Buffer.ReadBoolean(), Buffer.ReadASCIIString()
...
Public Sub WriteWalk(ByVal Heading As Heading)
'***************************************************
'Author: Juan Martín Sotuyo Dodero (Maraxus)
'Last Modification: 05/17/06
'Writes the "Walk" message to the outgoing data buffer
...
Public Sub WriteChangeHeading(ByVal Heading As Heading)
'***************************************************
'Author: Juan Martín Sotuyo Dodero (Maraxus)
'Last Modification: 05/17/06
'Writes the "ChangeHeading" message to the outgoing data buffer
...
Sub Login() 'Parra: Estado login hay que volarlo y mejorar la conexión...
