...
If List1(index).List(List1(index).ListIndex) = vbNullString Or _
   List1(index).ListIndex < 0 Then Exit Sub ' GSZ
...
Select Case index
    Case 0
        ...
        Engine.Graphics_Draw_GrhToHdc Picture1.hdc, NPCInventory(List1(0).ListIndex + 1).GrhIndex
