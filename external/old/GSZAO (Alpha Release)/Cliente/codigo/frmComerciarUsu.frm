...
Private Sub list1_Click()
    If Inventario.GrhIndex(List1.ListIndex + 1) <> 0 Then
        Engine.Graphics_Draw_GrhToHdc Picture1.hdc, Inventario.GrhIndex(List1.ListIndex + 1)
    End If
End Sub
...
If List2.ListIndex >= 0 And OtroInventario(List2.ListIndex + 1).GrhIndex <> 0 Then
    Engine.Graphics_Draw_GrhToHdc Picture1.hdc, OtroInventario(List2.ListIndex + 1).GrhIndex
